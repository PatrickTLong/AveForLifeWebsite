...
export default function Footer() {
    ...
    return (
        <div className={`flex justify-center  items-center ${windowWidth >= 640 ? 'flex-row' : 'flex-col'} bg-pink-200 border-pink-100 border-t-4 shadow-2xl  gap-20 p-28   text-white`}>
            {/* Media */}
